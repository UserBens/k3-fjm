...
<body class="flex h-screen overflow-hidden">
            ...
            <div class="section-card">
                <div class="filter-bar">
                    <div class="filter-search">
                        ...
                        <input type="text" id="fSearch" placeholder="Cari area, aktivitas, potensi bahaya..."
                            oninput="onFilterChange()" />
                    </div>
                    <select id="fTingkatRisiko" class="filter-select" onchange="onFilterChange()">
                ...
                <div class="data-summary">Menampilkan <strong id="sumShowing">0</strong> dari <strong
                        id="sumTotal">0</strong> data HIRADC</div>
    ...
    <div id="itemModalOverlay" class="modal-overlay" onclick="closeItemModalOutside(event)">
        <div class="modal-box form-modal-box" onclick="event.stopPropagation()">
            <div style="margin-bottom:14px;">
                <div class="modal-title" id="itemModalTitle">Tambah Data HIRADC</div>
                <div style="font-size:12.5px;color:#94A3B8;" id="itemModalSub">Lengkapi identifikasi bahaya dan
                    penilaian risiko.</div>
            </div>
            <div class="form-modal-body">
                ...
                <div class="form-section-title">Penilaian Risiko Awal</div>
                <div class="form-grid">
                    <div class="form-group"><label class="form-label">Kemungkinan (L) 1-5</label><input
                            type="number" min="1" max="5" id="fLAwal" class="form-input"
                            oninput="recalcRisk()" /></div>
                    <div class="form-group"><label class="form-label">Keparahan (S) 1-5</label><input type="number"
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group"><label class="form-label">Kemungkinan Sesudah (L)</label><input
                            ...
                            oninput="recalcRisk()" /></div>
                    <div class="form-group"><label class="form-label">Keparahan Sesudah (S)</label><input
                            type="number" min="1" max="5" id="fSSesudah" class="form-input"
                            oninput="recalcRisk()" /></div>
                    <div class="form-group span-2"><label class="form-label">Tingkat Risiko Sesudah</label>
                        <div id="previewSesudah" class="risk-badge-preview sp-gray">—</div>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group"><label class="form-label">PIC</label><input type="text"
                            id="fPic" class="form-input" placeholder="Safety Officer" /></div>
    ...
    <div id="deleteConfirmOverlay" class="modal-overlay" onclick="closeDeleteModalOutside(event)">
        <div class="modal-box" onclick="event.stopPropagation()">
            ...
            <div class="modal-title">Hapus Data HIRADC?</div>
    ...
    <script>
        ...
        async function loadData() {
            try {
                ...
                document.getElementById('tableBody').innerHTML =
                    `<tr><td colspan="10"><div class="empty-state"><div class="empty-state-title">Gagal memuat data</div><div class="empty-state-sub">${escapeHtml(e.message)}</div></div></td></tr>`;
            }
        }
        ...
        function resetFilter() {
            ...
            document.getElementById('fTingkatRisiko').value = '';
        ...
        function applyFilter() {
            ...
            const tingkat = document.getElementById('fTingkatRisiko').value;
        ...
        function recalcRisk() {
            ...
            const lS = parseInt(document.getElementById('fLSesudah').value),
                sS = parseInt(document.getElementById('fSSesudah').value);
            document.getElementById('previewAwal').outerHTML = previewBadge('previewAwal', lA, sA);
            document.getElementById('previewSesudah').outerHTML = previewBadge('previewSesudah', lS, sS);
        }
        ...
        function openDeleteModal(id, label) {
            ...
            document.getElementById('deleteModalDesc').textContent =
                `Data HIRADC "${label}" akan dihapus permanen. Lanjutkan?`;
