...
<head>
    ...
    <title>Data Supplier APD &amp; Alkes — PT. Fokus Jasa Mitra</title>
...
<body class="flex h-screen overflow-hidden">
    ...
    <div id="main-content">
        ...
        <div id="page-content">
            ...
            <div class="page-hdr">
                <div class="page-hdr-top">
                    <div>
                        ...
                        <div class="pg-title">DATA SUPPLIER <span>APD &amp; ALKES</span></div>
                        <div class="pg-sub">Referensi distributor &amp; pabrikan resmi APD dan alat kesehatan.</div>
                    </div>
            ...
            <div class="section-card" style="margin-bottom:14px;">
                <div class="filter-bar">
                    <div class="filter-search">
                        ...
                        <input type="text" id="searchInput"
                            placeholder="Cari nama supplier, kategori, merk, kontak..." oninput="onSearchInput()" />
                    </div>
                    ...
                    <select id="filterWilayah" class="filter-select" onchange="onFilterChange()">
                ...
                <div class="data-summary" id="dataSummary">Memuat data supplier...</div>
    ...
    <div id="formModalOverlay" class="modal-overlay" onclick="closeFormModalOutside(event)">
        <div class="modal-box form-modal-box" onclick="event.stopPropagation()">
            <div class="form-modal-header">
                <div class="modal-title" id="formModalTitle">Tambah Supplier</div>
                <div class="detail-subtitle" id="formModalSub">Lengkapi data supplier di bawah ini.</div>
            </div>
            ...
            <div class="form-modal-body">
                ...
                <div class="form-grid">
                    <div class="form-group span-2">
                        ...
                        <input type="text" id="fNamaSupplier" class="form-input"
                            placeholder="PT Sumber Makmur Safety" />
                    </div>
                    <div class="form-group">
                        <label class="form-label">Kategori Produk</label>
                        <input type="text" id="fKategoriProduk" class="form-input"
                            placeholder="APD Umum, APD Pernapasan, dsb" />
                    </div>
                    <div class="form-group">
                        <label class="form-label">Merk Utama</label>
                        <input type="text" id="fMerkUtama" class="form-input"
                            placeholder="Krisbow, 3M, Honeywell" />
                    </div>
                    <div class="form-group span-2">
                        <label class="form-label">Jenis Supplier</label>
                        <select id="fJenisSupplier" class="form-select">
                            <option value="Distributor Resmi">Distributor Resmi</option>
                            <option value="Pabrikan">Pabrikan</option>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" id="fKontakPerson" class="form-input" placeholder="Nama PIC" />
                    </div>
                    <div class="form-group">
                        <label class="form-label">No. Telepon</label>
                        <input type="text" id="fNoTelepon" class="form-input" placeholder="021-xxxxxxx" />
                    </div>
                    <div class="form-group">
                        <label class="form-label">Email</label>
                        <input type="email" id="fEmail" class="form-input" placeholder="sales@supplier.com" />
                    </div>
                    <div class="form-group">
                        <label class="form-label">Wilayah</label>
                        <input type="text" id="fWilayah" class="form-input" placeholder="Jakarta / Nasional" />
                    </div>
                    <div class="form-group span-2">
                        <label class="form-label">Website</label>
                        <input type="text" id="fWebsite" class="form-input" placeholder="https://" />
                    </div>
                    <div class="form-group span-2">
                        <label class="form-label">Alamat</label>
                        <textarea id="fAlamat" class="form-textarea" rows="2" placeholder="Alamat kantor / gudang"></textarea>
                    </div>
                </div>

                <div class="form-section-title">Legalitas &amp; Catatan</div>
                <div class="form-grid">
                    <div class="form-group span-2">
                        <label class="form-label">Nomor Izin Edar (khusus alkes)</label>
                        <input type="text" id="fNomorIzinEdar" class="form-input"
                            placeholder="Kosongkan jika tidak ada" />
                    </div>
                    <div class="form-group span-2">
                        <label class="form-label">Catatan</label>
                        <textarea id="fCatatan" class="form-textarea" rows="2" placeholder="Distributor resmi Krisbow, dsb"></textarea>
                    </div>
                </div>
            ...
            <div class="detail-modal-header">
                <div style="display:flex; align-items:center; gap:12px;">
                    ...
                    <div>
                        ...
                        <div class="detail-subtitle" id="detailKategoriSub">-</div>
                    </div>
                </div>
            ...
            <div class="detail-modal-body">
                <div class="detail-section">
                    ...
                    <div class="detail-form-grid">
                        <div class="detail-field"><label>Kategori Produk</label><input type="text"
                                id="dKategoriProduk" readonly></div>
                        <div class="detail-field"><label>Merk Utama</label><input type="text" id="dMerkUtama"
                                readonly></div>
                        <div class="detail-field span-2"><label>Jenis Supplier</label><input type="text"
                                id="dJenisSupplier" readonly></div>
                    </div>
                </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-form-grid">
                        <div class="detail-field"><label>Kontak Person</label><input type="text"
                                id="dKontakPerson" readonly></div>
                        <div class="detail-field"><label>No. Telepon</label><input type="text" id="dNoTelepon"
                                readonly></div>
                        <div class="detail-field"><label>Email</label><input type="text" id="dEmail" readonly>
                        </div>
                        <div class="detail-field"><label>Wilayah</label><input type="text" id="dWilayah"
                                readonly>
                        </div>
                        <div class="detail-field span-2"><label>Website</label><input type="text" id="dWebsite"
                                readonly></div>
                        <div class="detail-field span-2"><label>Alamat</label>
                            <textarea id="dAlamat" readonly rows="2"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-form-grid">
                        <div class="detail-field span-2"><label>Nomor Izin Edar</label><input type="text"
                                id="dNomorIzinEdar" readonly></div>
                        <div class="detail-field span-2"><label>Catatan</label>
                            <textarea id="dCatatan" readonly rows="2"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-form-grid">
                        <div class="detail-field span-2"><label>Status</label><input type="text" id="dStatus"
                                readonly></div>
                    </div>
                </div>
            </div>
    ...
    <div id="deleteConfirmOverlay" class="modal-overlay" onclick="closeDeleteModalOutside(event)">
        <div class="modal-box" onclick="event.stopPropagation()">
            ...
            <div class="modal-title">Hapus Data Supplier?</div>
    ...
    <script>
        const DATA_ENDPOINT = "{{ route('master-supplier-apd.data') }}";
        const STORE_ENDPOINT = "{{ route('master-supplier-apd.store') }}";
        const BASE_ENDPOINT = "{{ url('/master-supplier-apd') }}";
        ...
        function jenisPillClass(j) {
            if (j === 'Pabrikan') return 'sp-blue';
            if (j === 'Distributor Resmi') return 'sp-green';
            if (j === 'Agen') return 'sp-amber';
            return 'sp-gray';
        }
        ...
        function onFilterChange() {
            ...
            state.wilayah = document.getElementById('filterWilayah').value;
        ...
        function populateFilterOptions(options) {
            ...
            build('filterJenis', options.jenis || []);
            build('filterWilayah', options.wilayah || []);
                ...
                <tr>
                    <td>
                        <div class="td-name-cell">
                            <div class="td-avatar">${escapeHtml(initials(row.nama_supplier))}</div>
                            <div>
                                <div class="td-name-main">${escapeHtml(row.nama_supplier)}</div>
                                <div class="td-name-sub">${escapeHtml(row.email || '-')}</div>
                            </div>
                        </div>
                    </td>

                    <td>
                        <span class="status-pill sp-blue">${escapeHtml(row.kategori_produk)}</span>
                    </td>

                    <td>
                        <div class="td-name-sub" style="color:#334155;font-weight:600;">${escapeHtml(row.merk_utama || '-')}</div>
                    </td>

                    <td>
                        <div class="info-line"><b>${escapeHtml(row.kontak_person || '-')}</b></div>
                        <div class="info-line">${escapeHtml(row.no_telepon || '-')}</div>
                    </td>

                    <td>
                        <div class="info-line" style="margin-bottom:4px;">${escapeHtml(row.wilayah || '-')}</div>
                        <span class="status-pill ${jenisPillClass(row.jenis_supplier)}">${escapeHtml(row.jenis_supplier || '-')}</span>
                    </td>
                    ...
                    <td style="text-align:center; white-space:nowrap;">
                        ...
                        <button class="btn-row-action" onclick="openDeleteModal(${row.id}, '${escapeHtml(row.nama_supplier)}')">
        ...
        function renderError(message) {
            ...
            document.getElementById('dataSummary').textContent = 'Gagal memuat data supplier.';
        }
        ...
        function renderPagination(meta) {
            ...
            document.getElementById('dataSummary').innerHTML = `<strong>${meta.total}</strong> supplier ditemukan`;
        ...
        async function loadData() {
            ...
            if (state.jenis) params.set('jenis', state.jenis);
        ...
        function openFormModal(row = null) {
            ...
            document.getElementById('formModalTitle').textContent = row ? 'Edit Data Supplier' : 'Tambah Supplier';
            document.getElementById('formModalSub').textContent = row ? `Perbarui data untuk ${row.nama_supplier}` :
                'Lengkapi data supplier di bawah ini.';

            document.getElementById('fNamaSupplier').value = row?.nama_supplier || '';
            document.getElementById('fKategoriProduk').value = row?.kategori_produk || '';
            document.getElementById('fMerkUtama').value = row?.merk_utama || '';
            document.getElementById('fJenisSupplier').value = row?.jenis_supplier || 'Distributor Resmi';
            document.getElementById('fKontakPerson').value = row?.kontak_person || '';
            document.getElementById('fNoTelepon').value = row?.no_telepon || '';
            document.getElementById('fEmail').value = row?.email || '';
            document.getElementById('fWilayah').value = row?.wilayah || '';
            document.getElementById('fWebsite').value = row?.website || '';
            document.getElementById('fAlamat').value = row?.alamat || '';
            document.getElementById('fNomorIzinEdar').value = row?.nomor_izin_edar || '';
            document.getElementById('fCatatan').value = row?.catatan || '';
        ...
        async function submitForm() {
            ...
            const payload = {
                nama_supplier: document.getElementById('fNamaSupplier').value.trim(),
                kategori_produk: document.getElementById('fKategoriProduk').value.trim(),
                merk_utama: document.getElementById('fMerkUtama').value.trim() || null,
                jenis_supplier: document.getElementById('fJenisSupplier').value,
                kontak_person: document.getElementById('fKontakPerson').value.trim() || null,
                no_telepon: document.getElementById('fNoTelepon').value.trim() || null,
                email: document.getElementById('fEmail').value.trim() || null,
                wilayah: document.getElementById('fWilayah').value.trim() || null,
                website: document.getElementById('fWebsite').value.trim() || null,
                alamat: document.getElementById('fAlamat').value.trim() || null,
                nomor_izin_edar: document.getElementById('fNomorIzinEdar').value.trim() || null,
        ...
        function openDetailModal(row) {
            document.getElementById('detailAvatar').textContent = initials(row.nama_supplier);
            document.getElementById('detailNamaTitle').textContent = row.nama_supplier || '-';
            document.getElementById('detailKategoriSub').textContent = row.kategori_produk || '-';

            document.getElementById('dKategoriProduk').value = row.kategori_produk || '-';
            document.getElementById('dMerkUtama').value = row.merk_utama || '-';
            document.getElementById('dJenisSupplier').value = row.jenis_supplier || '-';

            document.getElementById('dKontakPerson').value = row.kontak_person || '-';
            document.getElementById('dNoTelepon').value = row.no_telepon || '-';
            document.getElementById('dEmail').value = row.email || '-';
            document.getElementById('dWilayah').value = row.wilayah || '-';
            document.getElementById('dWebsite').value = row.website || '-';
            document.getElementById('dAlamat').value = row.alamat || '-';

            document.getElementById('dNomorIzinEdar').value = row.nomor_izin_edar || '-';
            document.getElementById('dCatatan').value = row.catatan || '-';
