    ...
    public function data(Request $request): JsonResponse
    {
        try {
            ...
            $transformed = collect($paginator->items())->map(fn(ToolboxMeeting $item) => [
                ...
                'foto_tbm' => $item->foto_tbm ? (str_starts_with($item->foto_tbm, 'http') ? $item->foto_tbm : asset('storage/' . $item->foto_tbm)) : null,
                'foto_daftar_hadir' => $item->foto_daftar_hadir ? (str_starts_with($item->foto_daftar_hadir, 'http') ? $item->foto_daftar_hadir : asset('storage/' . $item->foto_daftar_hadir)) : null,
                'dokumen_laporan_kegiatan' => $item->dokumen_laporan_kegiatan ? (str_starts_with($item->dokumen_laporan_kegiatan, 'http') ? $item->dokumen_laporan_kegiatan : asset('storage/' . $item->dokumen_laporan_kegiatan)) : null,
            ]);
